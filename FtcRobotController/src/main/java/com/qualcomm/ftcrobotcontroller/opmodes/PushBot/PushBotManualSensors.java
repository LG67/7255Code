 ...
 * drive motors, left rZip motor, servo motors and gamepad input from two
 * gamepads for the Push Bot.  This manual op-mode use the touch sensors and
 * gamepad controls to drive the rZip to a predefined position (i.e. the location
 * of the touch sensor).
 *
 * @author SSI Robotics
...

{
...

    {
        ...
        //
        // Does the user want the rZip to rise until the touch sensor is
        ...
        if (gamepad2.y)
        {
            ...
            // do not set power to the rZip once the touch sensor has been
            // triggered.
            //
        ...
        //
        // Has the user commanded the rZip to be raised until the touch sensor
        // has been pressed?
        //
        ...
        // to the rZip motor according to the joystick value.
        //
        else
        {
            v_raise_arm_automatically = false;
        ...
        telemetry.addData ("19", "Left rZip command: " + l_arm_command);
    ...
    // released.  The rZip is only driven when the button has been pressed AND
