 ...
 * drive motors and associated encoders, the left rZip motor and associated touch
...

{
...

    {
        ...
        case 6:
            ...
            {
                //
                // Begin the next state.  Open the lZip.
                //
                open_hand ();
    ...
    //
    /**
     * Implement a state machine that controls the rZip during auto-operation.
     */
...

    {
        ...
        switch (v_arm_state)
        {
            ...
            case 1:
                //
                // Continue moving the rZip up.  If the touch sensor is
                // triggered, then the rZip will stop and this call will perform
